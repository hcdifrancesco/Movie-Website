...
# Creating an instance of each movie
the_hurt_locker = media.Movie(
    "The Hurt Locker",
    "A revealing and subtle portrait of the war in the Iraq through the story \
    of a 3 man EOD team.",
...
rain_man = media.Movie(
    "Rain Man",
    "Charlie Babbitt discovers that his father has given the entire estate \
    to Raymond, his father's other son and an autistic savant.",
...
a_beautiful_mind = media.Movie(
    "A Beautiful Mind",
    "John Nash, brilliant mathematician, accepts work in cryptography \
    and his life takes a turn for the worse.",
    ...
    "Best Picture, Best Actress in a Supporting Role, Best Director,\
     Best Writing")

lawrence_of_arabia = media.Movie(
    "Lawrence of Arabia",
    "T.E Lawrence is sent to Arabia to liaise between British and \
    Bedouin tribes but ends up going rogue and rallying the Arabs \
     to attack Aqaba from the Desert.",
    ...
    "Best Picture, Best Director, Best Cinematography,\
     Best Art Direction, Best Sound, Best Film Editing, Best Original Score")

birdman = media.Movie(
    "Birdman",
    "Riggan Thompson, failed Hollywood star, tries to mount a Broadway\
     adaptation of a Raymond Carver short story.",
...
slumdog_millionaire = media.Movie(
    "Slumdog Millionaire",
    "Jamal Malik, an eighteen year-old from a slum, is about to win India's\
     version of Who Wants to Be A Millionaire. Then reality catches up.\
    ...
    "Best Picture, Best Director, Best Adapted Screenplay,\
     Best Achievement in Cinematography, Best Film Editing, Best Original\
      Score, Best Original Song, Best Achievement in Sound Mixing")

# Storing instances of Movie in an Array.
movies = [the_hurt_locker, rain_man, a_beautiful_mind,
          lawrence_of_arabia, birdman, slumdog_millionaire]
